""" Objectiu: Escriure en un fitxer de sortida el format de subtítols SRT."""
...
#Obro fitxer d'escriptura
fSubt = open('subt_arxiu73_002.srt','w')
  ...
  for lin2 in fL:
    ...
    while len(lin1):
      ...
      if(len(lin1) > 35):
        ...
        fSubt.write(num_subt)

        fSubt.write(marca_ini," --> ",marca_fin)
